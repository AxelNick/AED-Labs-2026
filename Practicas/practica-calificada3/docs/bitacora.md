 ...
 * **Día 4 (07/06/2026):** Implementación de las pruebas automatizadas en `test_smart_infants.cpp`. Cubriendo los 6 escenarios exigidos por la rúbrica: 
  ...
  * **Día 8 (11/06/2026)** : Preparación final y grabación de la sustentación técnica. Se prepararon las diapositivas de soporte en Canva y se ensayaron los comandos de consola. Se grabó exitosamente el video de 31 minutos cumpliendo con los 6 bloques exigidos por la rúbrica. Durante el Bloque 6, se ejecutó en vivo y sin cortes el reto específico del problema, validando la traza de colapso de guardería y actualización de máximos. Finalmente, se generaron los enlaces del video y de la presentación para anexarlos a la entrega del repositorio.